                                ...
                                for (var c in e)
                                    if (i(e, c)) {
                                        ...
                                        if (!f || f instanceof Error || n((s || "React class") + ": type specification of " + r + " `" + c + "` is invalid; the type checker function must return `null` or an `Error` but returned a " + typeof f + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."), f instanceof Error && !(f.message in a)) {
                                            a[f.message] = !0;
                                            var p = u ? u() : "";
                                            n("Failed " + r + " type: " + f.message + (null != p ? p : ""))
                                        }
                                    }
                            }
                            n = function(e) {
                            ...
                            u = function(e) {
                                    ...
                                    l = {
                                        ...
                                        arrayOf: function(e) {
                                            return y(function(t, r, n, o, i) {
                                                ...
                                                if (!Array.isArray(s)) {
                                                    var u = h(s);
                                                    return new p("Invalid " + o + " `" + i + "` of type " + ("`" + u + "` supplied to `") + n + "`, expected an array.")
                                                }
                                        ...
                                        element: y(function(t, r, n, o, a) {
                                            ...
                                            if (!e(i)) {
                                                var s = h(i);
                                                return new p("Invalid " + o + " `" + a + "` of type " + ("`" + s + "` supplied to `") + n + "`, expected a single ReactElement.")
                                            }
                                            return null
                                        }),
                                        elementType: y(function(e, t, r, o, a) {
                                            ...
                                            if (!n.isValidElementType(i)) {
                                                var s = h(i);
                                                return new p("Invalid " + o + " `" + a + "` of type " + ("`" + s + "` supplied to `") + r + "`, expected a single ReactElement type.")
                                            }
                                            return null
                                        }),
                                        instanceOf: function(e) {
                                            return y(function(t, r, n, o, a) {
                                                if (!(t[r] instanceof e)) {
                                                    var i, s = e.name || f,
                                                        u = (i = t[r], i.constructor && i.constructor.name ? i.constructor.name : f);
                                                    return new p("Invalid " + o + " `" + a + "` of type " + ("`" + u + "` supplied to `") + n + "`, expected instance of `" + s + "`.")
                                                }
                                                return null
                                            })
                                        },
                                        node: y(function(t, n, o, a, i) {
                                            return ! function t(n) {
                                                switch (typeof n) {
                                                    case "number":
                                                    case "string":
                                            ...
                                            }(t[n]) ? new p("Invalid " + a + " `" + i + "` supplied to `" + o + "`, expected a ReactNode.") : null
                                        }),
                                        objectOf: function(e) {
                                        ...
                                        oneOfType: function(e) {
                                            ...
                                            for (var t = 0; t < e.length; t++) {
                                                var r = e[t];
                                                if ("function" != typeof r) return u("Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + g(r) + " at index " + t + "."), c
                                            }
                                            return y(function(t, r, n, o, s) {
                                                ...
                                                return new p("Invalid " + o + " `" + s + "` supplied to " + ("`" + n + "`") + l + ".")
                                            })
                                        },
                                        shape: function(e) {
                                            return y(function(t, r, n, o, i) {
                                                ...
                                                for (var c in e) {
                                                    var f = e[c];
                                                    if ("function" != typeof f) return v(n, o, i, c, b(f));
                                        ...
                                        exact: function(e) {
                                            return y(function(t, r, n, s, u) {
                                                ...
                                                for (var d in l) {
                                                    var y = e[d];
                                                    if (i(e, d) && "function" != typeof y) return v(n, s, u, d, b(y));
                                ...
                                function y(e) {
                                    ...
                                    function o(o, i, s, c, l, d, y) {
                                        ...
                                        return null != i[s] ? e(i, s, c, l, d) : o ? new p(null === i[s] ? "The " + l + " `" + d + "` is marked as required in `" + c + "`, but its value is `null`." : "The " + l + " `" + d + "` is marked as required in `" + c + "`, but its value is `undefined`.") : null
                                    }
                                    var i = o.bind(null, !1);
                                ...
                                function m(e) {
                                    return y(function(t, r, n, o, a, i) {
                                        ...
                                        if (h(s) !== e) {
                                            var u = b(s);
                                            return new p("Invalid " + o + " `" + a + "` of type " + ("`" + u + "` supplied to `") + n + "`, expected `" + e + "`.", {
                                                expectedType: e
                                            })
                                        }
                                        return null
                                ...
                                function h(e) {
                                    var t, r, n = typeof e;
                                    return Array.isArray(e) ? "array" : e instanceof RegExp ? "object" : "symbol" === n || e && ("Symbol" === e["@@toStringTag"] || "function" == typeof Symbol && e instanceof Symbol) ? "symbol" : n
                                }
                        ...
                        "./src/toQuery.ts": function(e, t, r) {
                            ...
                            var o = n(r( /*! hyphenate-style-name */ "./node_modules/hyphenate-style-name/index.js")),
                                ...
                                i = function(e, t) {
                                    ...
                                    return ("number" == typeof t && (t = "".concat(t, "px")), !0 === t) ? n : !1 === t ? (r = n, "not ".concat(r)) : "(".concat(n, ": ").concat(t, ")")
                                },
                                s = function(e) {
                                    var t, r = [];
                                    return Object.keys(a.default.all).forEach(function(t) {
                                        var n = e[t];
                                        null != n && r.push(i(t, n))
                                    }), r.join(" and ")
                                };
